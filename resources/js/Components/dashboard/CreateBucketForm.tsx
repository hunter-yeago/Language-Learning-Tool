...
export default function CreateBucketForm({ bucketData, setData, post, data, onCancel, processing }: CreateBucketFormProps) {
  function handleCreateNewBucket(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault()
